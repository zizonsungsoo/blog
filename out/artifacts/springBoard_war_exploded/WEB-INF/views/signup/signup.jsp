...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#registerForm').validate({
            rules: {
                id: {required: true, minlength: 4, maxlength: 15, regex:/^[a-z0-9]{4,15}$/,remote: "id_chk.jsp"},
                pw: {
                    required: true,
                    regex: /^(?=.*[a-z])(?=.*[A-Z]).{4,12}$/,
                    rangelength: [4, 15]
                ...
                passwd2: {equalTo: pw,},
                nick: {required: true, remote: "nick_chk.jsp"},
                name: {
                    required: true,
                    regex:/^[가-힝]{2,4}$/
                },
...
<div style="width: 600px;height:950px;background-color:white;margin: 0 auto;border-radius: 10px;margin-top: 20px;margin-bottom: 20px;padding: 25px 25px 25px 25px">
    <div style="text-align: center;">
        <a href="mainPage.jsp"><img src="img/title_banner_removebg.png"></a>
    </div>
    <!-- 1. 로고 -->
    <%-------------------------배너&툴바---------------------------%>
    <!-- 2. 필드 -->
    <div style="text-align:center">
        ...
        <form class="input_box" method="post" id="registerForm" action="inputPro.jsp" name="userinput"
            ...
            <!-- 6. 가입하기 버튼 -->
            <input type="submit" class="item" value="가입하기" id="input_bt">
        </form>
    </div>
</div>
</body>
